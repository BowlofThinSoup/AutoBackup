#实现数据完全备份与增量备份
import time,os,hashlib,sys,tarfile,pickle,Config
...
# def full_backup(src_dir,dst_dir):
...
def inc_backup(src_dir,dst_dir,md5file):
    if os.path.exists(md5file):
        ...
        if os.path.exists(src_dir):
            ...
            os.chdir(par_dir)
            # os.remove(full_name)
            tar = tarfile.open(full_name,'w:gz',encoding='utf-8')
